...
import com.omneAgate.activityKerosene.SalesEntryActivity;
...
public class CardWithOTPActivity extends BaseActivity implements SMSListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTamilText((TextView) findViewById(R.id.textViewOtp), R.string.inputCard);
        setTamilText((TextView) findViewById(R.id.textViewMobile), R.string.inputCard);
