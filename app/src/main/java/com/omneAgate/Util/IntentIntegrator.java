...
import com.omneAgate.Bunker.QRCodeSalesActivity;
...
public class IntentIntegrator {
    ...
    public static void initiateScan(QRCodeSalesActivity qrCodeSalesActivity, int activity_capture, int viewfinder_view, int preview_view, boolean b) {
    }
}