...
public class LogoutDialog extends Dialog implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTamilText((TextView) findViewById(R.id.textViewNwTitle), R.string.logout);
        setTamilText(message, R.string.logoutString);
        ...
        Util.LoggingQueue(context, "Logout", "Inside logout dialog");
    }
